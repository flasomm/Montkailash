...
function woo_create_default_templates() {
	...
	if( $template_muc_page_id ) { //Check template id
		...
		update_post_meta( $template_muc_page_id, $prefix . 'pdf_bg_style', 'color' );
	...
	if( $template_pink_page_id ) { //Check template id
		...
		update_post_meta( $template_pink_page_id, $prefix . 'pdf_bg_style', 'color' );
	...
	if( $template_blue_page_id ) { //Check template id
		...
		update_post_meta( $template_blue_page_id, $prefix . 'pdf_bg_style', 'color' );
	...
	if( $template_green_page_id ) { //Check template id
		...
		update_post_meta( $template_green_page_id, $prefix . 'pdf_bg_style', 'color' );
...
function woo_vou_append_voucher_role( $woo_vou_roles ) {
	...
	if( class_exists( 'WC_Vendors' ) ) {
		...
		//add new role for wcvender plugin
...
function woo_vou_voucher_download_text( $product_id ) {
	...
	return apply_filters( 'woo_vou_voucher_download_text', __( 'Bon d\'échange', 'woovoucher' ), $product_id );
}
