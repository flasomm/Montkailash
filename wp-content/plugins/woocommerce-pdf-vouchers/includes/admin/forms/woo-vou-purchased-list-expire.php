...
class WOO_Vou_Expire_List extends WP_List_Table {
	...
	function no_items() {
		...
		_e( 'No Unused voucher codes yet.', 'woovoucher' );
	}
...
<div class="wrap"><?php 
    ...
    <form id="product-filter" method="get" action="">
        ...
        <div class="alignright"><?php
			$generatexpirepdfurl = add_query_arg( array( 'woo-vou-voucher-gen-pdf' => '1' ) );
			$exportexpirecsvurl = add_query_arg( array( 'woo-vou-voucher-exp-csv'	=> '1' ) );?>
			
			<a href="<?php echo $exportexpirecsvurl; ?>" id="woo-vou-export-csv-btn" class="button-secondary woo-gen-pdf" title="<?php echo __( 'Export CSV', 'woovoucher' ); ?>"><?php echo __( 'Export CSV', 'woovoucher' ); ?></a>
			<a href="<?php echo $generatexpirepdfurl; ?>" id="woo-vou-pdf-btn" class="button-secondary" title="<?php echo __('Generate PDF','woovoucher'); ?>"><?php echo __( 'Generate PDF', 'woovoucher' ); ?></a>
		</div>
