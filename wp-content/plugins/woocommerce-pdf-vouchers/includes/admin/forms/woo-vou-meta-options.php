...
wp_nonce_field( WOO_VOU_PLUGIN_BASENAME, 'at_woo_vou_meta_box_nonce' );
	...
	woo_vou_content_begin();
		...
		woo_vou_add_image( array( 'id' => $prefix . 'pdf_bg_img', 'wrap_class' => 'woo-vou-meta-bg-image-wrap ' . $bg_image_css, 'name'=> __( 'Background Image:', 'woovoucher' ), 'desc' => __( 'Upload the background image for the PDF.', 'woovoucher' ) ) );
