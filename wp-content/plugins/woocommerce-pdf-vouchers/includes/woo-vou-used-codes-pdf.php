	...
	if( isset( $_GET['woo-vou-voucher-gen-pdf'] ) && !empty( $_GET['woo-vou-voucher-gen-pdf'] )
		...
		if( isset( $_GET['woo_vou_action'] ) && $_GET['woo_vou_action'] == 'used' ) { // if generate pdf for used code add and extra column
			$columns =  array(
								...
								'product_info' => array('name' => __('Product Information', 'woovoucher'), 'width' => 24),
								'buyer_info' 	=> array('name' => __('Buyer\'s Information', 'woovoucher'), 'width' => 28),
								'order_info' 	=> array('name' => __('Order Information', 'woovoucher'), 'width' => 26),								
								'redeem_by' 	=> array('name' => __('Redeem By', 'woovoucher'), 'width' => 10)
						);
		} else {
			$columns =  array(
...
add_action( 'admin_init', 'woo_vou_generate_voucher_code_pdf' );