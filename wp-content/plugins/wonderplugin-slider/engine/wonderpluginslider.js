...
(function ($) {
    $.fn.wonderpluginslider = function (options) {
                        ...
                        if (this.options.navdirection == "vertical") {
                            ...
                            if (this.options.navthumbnavigationstyle == "arrow") {
                                ...
                                if (this.options.navdirection == "horizontal")if (this.options.navmultirows) {
                                    ...
                                    var n = Math.floor(($nav.width() - 2 * m + this.options.navspacing) / (this.options.navwidth +
        ...
        this.each(function () {
            ...
            if ($(this).data("textformat") && typeof WONDERPLUGIN_SLIDER_TEXT_EFFECT_FORMATS !== "undefined")if ($(this).data("textformat")in WONDERPLUGIN_SLIDER_TEXT_EFFECT_FORMATS)this.options =
                $.extend({}, WONDERPLUGIN_SLIDER_TEXT_EFFECT_FORMATS[$(this).data("textformat")], this.options);
            ...
            if (this.options.versionmark != "AMC" + "om") {
                this.options.showwatermark = false;
