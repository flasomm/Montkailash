...
class WC_Email_Customer_Completed_Order extends WC_Email {
	...
	function __construct() {
		...
		// Other settings
		$this->heading_downloadable = $this->get_option( 'heading_downloadable', __( 'Your order is complete', 'woocommerce' ) );
		$this->subject_downloadable = $this->get_option( 'subject_downloadable', __( 'Your {site_title} order from {order_date} is complete', 'woocommerce' ) );
