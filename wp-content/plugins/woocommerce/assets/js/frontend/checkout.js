...
jQuery( function( $ ) {
	...
	var wc_checkout_form = {
		...
		init: function() {
            ...
            this.$checkout_form.on( 'change', '#destinataire-des-soins input', this.destinataire_des_soins );

			// Trigger events
			this.$order_review.find( 'input[name=payment_method]:checked' ).trigger( 'click' );
			this.$checkout_form.find( '#ship-to-different-address input' ).change();
            this.$checkout_form.find( '#destinataire-des-soins input' ).change();
        ...
        destinataire_des_soins: function() {
            $( 'div.recipient_fields' ).hide();
            if ( $( this ).is( ':checked' ) ) {
                $( 'div.recipient_fields' ).slideDown();
            }
        },
